...
const file_testpb_test_proto_rawDesc = "" +
	...
	"\x06answer\x18\x01 \x01(\tR\x06answer2\xef\x02\n" +
	"\vTestService\x12+\n" +
	...
	"\bTakeTest\x12\x15.test.TakeTestRequest\x1a\x0e.test.Question(\x010\x01B%Z#github.com/farinas09/go-grpc/testpbb\x06proto3"
