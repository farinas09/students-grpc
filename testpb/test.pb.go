...
import (
	studentpb "github.com/farinas09/go-grpc/studentpb"
...
const file_testpb_test_proto_rawDesc = "" +
	...
	"\atest_id\x18\x01 \x01(\tR\x06testId2\xb8\x02\n" +
	"\vTestService\x12+\n" +
	"\aGetTest\x12\x14.test.GetTestRequest\x1a\n" +
	".test.Test\x12,\n" +
	"\aSetTest\x12\n" +
	".test.Test\x1a\x15.test.SetTestResponse\x12;\n" +
	"\fSetQuestions\x12\x0e.test.Question\x1a\x19.test.SetQuestionResponse(\x01\x12F\n" +
	"\x0eEnrollStudents\x12\x17.test.EnrollmentRequest\x1a\x19.test.SetQuestionResponse(\x01\x12I\n" +
	"\x12GetStudentsPerTest\x12\x1f.test.GetStudentsPerTestRequest\x1a\x10.student.Student0\x01B%Z#github.com/farinas09/go-grpc/testpbb\x06proto3"
